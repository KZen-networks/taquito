                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            delegationParams = params.opOb.contents.find(function (content) { return content.kind === rpc.OpKind.DELEGATION; });
                            if (!delegationParams) {
                        ...
                        case 2:
                            operation = _b.sent();
                            return [2 /*return*/, new DelegateOperation(hash, operation, delegationParams.source, forgedBytes, opResponse, context)];
                    }
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            operation = _b.sent();
                            return [2 /*return*/, new TransactionOperation(hash, operation, transactionParams.source, forgedBytes, opResponse, context)];
                    }
                });
            });
        };
